 ...
 *
 * Visual: neo-brutalism + pastel pop. Header card tone "ulangan", soal
 * cards surface dengan emerald/rose highlight per jawaban.
 */
      ...
      <SiswaCard tone="ulangan" shadow="md">
        <SiswaCardHeader>
          <div className="flex flex-wrap items-start justify-between gap-2">
            <div>
              <SiswaCardTitle>Pembahasan Ulangan</SiswaCardTitle>
              <SiswaCardDescription>
            ...
            >
              <span
                className={cn(
                  ...
                  isCorrect && 'border-siswa-border bg-siswa-green text-emerald-800',
                  wronglyPicked && 'border-siswa-border bg-rose-200 text-rose-800',
