...
> Status: v0.11.10 — **Fase 5 ✅ CLOSED 15/15 + UX/QA pass `22d2095`** + **Fase 6 plan ✅ DECOMPOSED 15 task locked #83-#88 + 6.A.1 ✅ DONE `3371e30` + 6.B 3/3 ✅ CLOSED + 6.C 2/2 ✅ CLOSED + 6.D 4/4 ✅ CLOSED + 6.E 1/1 ✅ CLOSED**, 2026-05-22. Fase 6 BE 100% selesai (10/15 task = 67%). 6.E Hasil consolidated review+list+cancel+rekap hijau 37/37 smoke (incl two-sentinel review gating review_locked vs review_disabled, soft-cancel idempotency, post-cancel slot-released attempt_no=1, DESC nulls-last sort, rata-rata over students-with-nilai). Coverage gate locked #88 ≥70% — defer to Fase 8 TODO (mirror Fase 5 #82 soft fallback). Lanjut 6.F FE Guru bank-soal + ujian setup pages.
> Owner: User (guru) + Apis (assistant)
> Last updated: 2026-05-22 (Fase 6.E.1 ✅ DONE commit `8f77dbc` — Ujian Hasil + Review + Cancel + Rekap consolidated, smoke E2E /tmp/qa-6e1.sh 37/37 PASS. Fase 6 BE 10/10 ✅ CLOSED. Coverage gate locked #88 ≥70% deferred to Fase 8 TODO. Roadmap v0.11.10.)
...
- 6.F FE Guru: 2/2 — 6.F.1 `/guru/bank-soal` page + SoalBank editor + bulk paste + image manager + tag filter (mirror 5.F.1 commit `8c74e38`), 6.F.2 `/guru/kelas/[id]/ujian` setup form + Sumber soal switcher (manual pick / random filter) + RekapHasilUjian + CancelAttemptConfirmDialog + UjianPreviewDialog (mirror 5.F.2 commit `4195efa`)
