...
> Status: v0.11.11 — **Fase 5 ✅ CLOSED 15/15 + UX/QA pass `22d2095`** + **Fase 6 plan ✅ DECOMPOSED 15 task locked #83-#88 + 6.A.1 ✅ DONE `3371e30` + 6.B 3/3 ✅ CLOSED + 6.C 2/2 ✅ CLOSED + 6.D 4/4 ✅ CLOSED + 6.E 1/1 ✅ CLOSED + 6.F.1 ✅ DONE `1269846`**, 2026-05-22. Fase 6 progress 12/15 = 80%. BE 100% selesai. FE Guru kicked off: BankSoal page (`/guru/bank-soal`) + editor + bulk paste + tag filter shipped, smoke wiring 14/14 hijau, Next build hijau (route 14.9 kB / 153 kB First Load JS, masuk static export). Lanjut 6.F.2 FE Guru Ujian setup.
> Owner: User (guru) + Apis (assistant)
> Last updated: 2026-05-22 (Fase 6.F.1 ✅ DONE commit `1269846` — `/guru/bank-soal` page + BankSoalList + BankSoalEditDialog + BankSoalBulkPasteDialog + tag filter, smoke /tmp/qa-6f1.sh 14/14 PASS, Next build hijau. Roadmap v0.11.11.)
...
**Eksekusi berikutnya: Fase 6 plan ✅ DECOMPOSED 15 task — locked #83-#88. 6.A.1 ✅ DONE `3371e30`. 6.B 3/3 ✅ CLOSED (`f50e7f2`+`76de898`+`ceaf86b`). 6.C 2/2 ✅ CLOSED (`ede3194`). 6.D 4/4 ✅ CLOSED (`7d465bf`+`d2ecef9`+`205be54`+`0df6f89`). 6.E 1/1 ✅ CLOSED (`8f77dbc`) — Fase 6 BE 100%. 6.F.1 ✅ DONE (`1269846`) — `/guru/bank-soal` page + editor + bulk paste + tag filter, smoke 14/14 PASS. Coverage gate locked #88 ≥70% deferred to Fase 8 TODO. Lanjut 6.F.2 FE Guru `/guru/kelas/[id]/ujian` setup form (mirror 5.F.2 `4195efa`).**
