...
> Status: v0.11.12 — **Fase 5 ✅ CLOSED 15/15 + UX/QA pass `22d2095`** + **Fase 6 plan ✅ DECOMPOSED 15 task locked #83-#88 + 6.A.1 ✅ DONE `3371e30` + 6.B 3/3 ✅ CLOSED + 6.C 2/2 ✅ CLOSED + 6.D 4/4 ✅ CLOSED + 6.E 1/1 ✅ CLOSED + 6.F 2/2 ✅ CLOSED `1269846`+`446f187`**, 2026-05-22. Fase 6 progress 13/15 = 87%. BE 100% + FE Guru 100%. 6.F.2 wired Ulangan tab di kelas detail dengan UjianFormDialog + UjianSourceConfigPanel discriminated manual/random + Live Preview + RekapHasilUjianTable + CancelUjianAttemptDialog. Lanjut 6.G FE Siswa 2/2 (lobby + player+review) untuk close Fase 6.
> Owner: User (guru) + Apis (assistant)
> Last updated: 2026-05-22 (Fase 6.F.2 ✅ DONE commit `446f187` — UjianList tab di kelas detail + form CRUD + source switcher manual/random + preview + rekap + cancel attempt, smoke /tmp/qa-6f2.sh 14/14 PASS, Next build hijau. Roadmap v0.11.12.)
...
- 6.G FE Siswa: 2/2 — 6.G.1 `/siswa/ujian` page list aktif/upcoming/history + UjianLobby (mirror 5.G.1 commit `1716fab`), 6.G.2 UjianPlayer + UjianReview + UjianSection orchestrator state machine (mirror 5.G.2 commit `6c10d19`)
