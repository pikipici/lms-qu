...
- [ ] Fase 5 — Soal Bab (plan ✅ DECOMPOSED 15 task locked #76-#82, 2/15 — 5.A.1 ✅ DONE commits `c83a15e` migration 000010 + `d63124d` model+repo skeleton; 5.B.1 ✅ DONE commit `928401b` CRUD + handler wiring + smoke E2E; 5.B.2 ✅ DONE commit `57eb504` image upload 6-slot + resize 1920px + presign 15m + smoke 6 negative tests pass; ⏳ NEXT 5.B.3 bulk paste pipe-delimited)
