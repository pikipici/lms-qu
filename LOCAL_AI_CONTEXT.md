...
- Roadmap & locked decisions: `.kiro/steering/lms-roadmap.md` (v0.12.0 — Fase 7 OPEN, decomposed 12 task A-G, head `dc7896b`).
  - Fase 4 14/14, Fase 5 15/15 + UX/QA pass `22d2095`, Fase 6 15/15 + UX/QA pass `6e10888`, **Fase 7 IN PROGRESS** (7.A.1 ✅ + 7.A.2 ✅ + 7.B ✅ + 7.C ✅ + 7.D ✅ + **7.E ✅ guru audit scope** commit `dc7896b`, smoke 7.A 16/16 + 7.B 17/17 + 7.C 16/16 + 7.D 11/11 + 7.E 20/20 hijau).
...
- Active focus: **Fase 7 Task 7.F — UX/QA pass** (dogfood Fase 7 end-to-end: 7.A siswa nilai + 7.B guru rekap + CSV + 7.C activity feed + 7.D pending counters + 7.E audit log; fix findings; comprehensive smoke).
...
- [-] Fase 7 — Rekap Nilai + Activity Feed (IN PROGRESS, decomposed 12 task A-G, head `dc7896b`)
  ...
  - **Next**: Task 7.F — UX/QA pass dogfood Fase 7 end-to-end + comprehensive smoke + fix findings, lalu 7.G close v0.13.0.
- [ ] Fase 7 (sisa) — 7.F UX/QA pass / 7.G close v0.13.0
- [ ] Fase 8 — Polish + E2E
