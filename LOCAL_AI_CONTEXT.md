...
- Roadmap & locked decisions: `.kiro/steering/lms-roadmap.md` (v0.11.2 — Fase 4 ✅ CLOSED 14/14, **Fase 5 ✅ CLOSED 15/15 + UX/QA pass `22d2095`**, **Fase 6 plan ✅ DECOMPOSED 15 task locked #83-#88 + 6.A.1 ✅ DONE `3371e30` + 6.B.1 ✅ DONE `f50e7f2`**).
...
- [ ] Fase 6 — Ulangan Harian (cross-bab) — plan ✅ DECOMPOSED 15 task locked #83-#88; estimasi 7 hari. **6.A foundation 1/1 ✅ DONE** commit `3371e30` — migration 000011 + 7 model + repo skeleton, 6 tables (bank_soal, ujian, ujian_soal, hasil_ujian, jawaban_ujian, event_ujian) + 17 indexes, up→11 + down round-trip + up clean, schema_version `000011_ujian`. **6.B BankSoal 1/3 ✅** — 6.B.1 ✅ DONE commit `f50e7f2` CRUD per-guru pribadi (handler+service+repo) smoke E2E /tmp/qa-6b1.sh 26/26 PASS (create/list/filter mapel/get/patch version-bump/version-conflict 409/siswa 403/guru2 cross-guru 403/jawaban_invalid 400/soft delete + GET 404 + list excludes). Sisa: 6.B.2 image upload 6-slot R2 `soal-bank/` + 6.B.3 bulk paste + 6.C Ujian setup CRUD/duplicate/source 2/2 + 6.D Ujian flow start/answer/submit/cron 4/4 + 6.E Hasil consolidated review/list/cancel/rekap 1/1 + 6.F FE Guru bank-soal/ujian setup+rekap 2/2 + 6.G FE Siswa list/lobby/player/review 2/2. Bank Soal per-guru pribadi (locked #84), Ujian source manual/random (locked #85), seed sha256 mirror locked #79 (locked #86), timer cron reuse goroutine SoalBab (locked #87), coverage 70% (locked #88).
