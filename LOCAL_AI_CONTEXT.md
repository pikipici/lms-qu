...
- [ ] Fase 5 — Soal Bab (plan ✅ DECOMPOSED 15 task locked #76-#82, 1/15 — 5.A.1 ✅ DONE commits `c83a15e` migration 000010 + `d63124d` model+repo skeleton; ⏳ NEXT 5.B.1 SoalBab CRUD)
