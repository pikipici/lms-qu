...
- Roadmap & locked decisions: `.kiro/steering/lms-roadmap.md` (v0.11.7 — Fase 4 ✅ CLOSED 14/14, **Fase 5 ✅ CLOSED 15/15 + UX/QA pass `22d2095`**, **Fase 6 plan ✅ DECOMPOSED 15 task locked #83-#88 + 6.A.1 ✅ DONE `3371e30` + 6.B 3/3 ✅ CLOSED `f50e7f2`+`76de898`+`ceaf86b` + 6.C 2/2 ✅ CLOSED `ede3194` + 6.D 2/4 ✅ DONE `7d465bf`+`d2ecef9`**).
