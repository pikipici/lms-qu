...
- [ ] Fase 5 — Soal Bab (plan ✅ DECOMPOSED 15 task locked #76-#82, 6/15 — 5.A foundation 1/1 ✅ + 5.B BE CRUD/image/bulk 3/3 ✅ + 5.C BE Setting+Latihan 2/2 ✅ + 5.D.1 Ulangan start deterministic seed ✅ commits `c83a15e`+`d63124d`+`928401b`+`57eb504`+`dabbdf1`+`7b9edd5`+`d6c808d`+`0346609`+`32f63ae`+`d822d46`; ⏳ NEXT 5.D.2 Ulangan answer save autosave 5s)
