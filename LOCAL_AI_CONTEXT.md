...
- Roadmap & locked decisions: `.kiro/steering/lms-roadmap.md` (v0.11.0 — Fase 4 ✅ CLOSED 14/14, **Fase 5 ✅ CLOSED 15/15 + UX/QA pass `22d2095`**, **Fase 6 plan ✅ DECOMPOSED 15 task locked #83-#88**).
...
- [ ] Fase 6 — Ulangan Harian (cross-bab) — plan ✅ DECOMPOSED 15 task locked #83-#88; estimasi 7 hari. 6.A foundation 1/1 + 6.B BankSoal CRUD/image/bulk 3/3 + 6.C Ujian setup CRUD/duplicate/source 2/2 + 6.D Ujian flow start/answer/submit/cron 4/4 + 6.E Hasil consolidated review/list/cancel/rekap 1/1 + 6.F FE Guru bank-soal/ujian setup+rekap 2/2 + 6.G FE Siswa list/lobby/player/review 2/2. Bank Soal per-guru pribadi (locked #84), Ujian source manual/random (locked #85), seed sha256 mirror locked #79 (locked #86), timer cron reuse goroutine SoalBab (locked #87), coverage 70% (locked #88). **Mulai eksekusi 6.A.1 setelah user approve.**
