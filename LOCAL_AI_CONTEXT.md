...
- [ ] Fase 3 — Bab & Materi + Pengumuman (in progress 7/17 = 38%; 3.A backend 4/4 DONE, 3.B FE Guru 2/2 DONE 2026-05-21 commits `97d7b28` + `5282cad`, 3.C Materi BE 1/4 DONE 2026-05-21 commit `7772f63` migration 000006 + GORM model + repo)
- [ ] Fase 4 — Tugas
- [ ] Fase 5 — Soal Bab
