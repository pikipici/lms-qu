...
- [ ] Fase 3 — Bab & Materi + Pengumuman (in progress 15/17 = 88%; 3.A backend 4/4 DONE, 3.B FE Guru 2/2 DONE 2026-05-21 commits `97d7b28` + `5282cad`, 3.C Materi BE 4/4 CLOSED 2026-05-21: 3.C.1 commit `7772f63` migration 000006 + GORM model + repo, 3.C.2 commit `6e76b4c` youtube+markdown CRUD + parseYouTubeID, 3.C.3 commit `8c2b495` PDF upload + presigned + compensating R2 cleanup, 3.C.4 commit `caad20a` siswa MarkRead idempotent + enrollment guard; 3.D Materi FE 2/2 CLOSED 2026-05-21: 3.D.1 commit `eeca652` Tab Materi guru, 3.D.2 commit `d08df3f` siswa viewer dispatcher 3-tipe + auto mark-read; 3.E Bab Siswa 2/2 CLOSED 2026-05-21: 3.E.1 commit `c0d795a` BE list+detail+progress di paket siswabab terpisah, 3.E.2 commit `3a69ddb` FE pages siswa kelas+bab detail dgn progress bar + materi viewer; 3.F Pengumuman 1/3: 3.F.1 commit `cf8c5bc` migration 000007 + CRUD endpoints + 18/18 tests, dev DB at version 7; tersisa 3.F.2 FE guru + 3.F.3 FE siswa)
- [ ] Fase 4 — Tugas
- [ ] Fase 5 — Soal Bab
