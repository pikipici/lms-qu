...
- [ ] Fase 2 — Kelas, Enrollment, Bulk Import (in progress: 11/20 — 2.A.1, 2.A.2, 2.B FULL, 2.C FULL DONE, 2.D.0.a DONE; next 2.D.0.b real R2 client, blocked on user R2 credentials)
