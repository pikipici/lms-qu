...
- Roadmap & locked decisions: `.kiro/steering/lms-roadmap.md` (v0.9.1 — Fase 3 closed + Fase 4 decomposed 14 task; Fase 4 progress 10/14 = 71%).
...
- [ ] Fase 4 — Tugas (plan ✅ DECOMPOSED 14 task v0.9.0; progress 10/14 = 71%: 4.A BE 3/4 ✅ DONE migration `b6a2cf9` + CRUD `dc7d237` + attachment `55fb86a`, 4.A.4 duplicate ⏳ deferable, 4.B FE Guru 2/2 ✅ DONE merged commit `c4acf54` kelas-wide+bab page; 4.C BE 4/4 ✅ DONE 4.C.1 migration 000009 + model + repo `55296be` + 4.C.2/4.C.3/4.C.4 submit/get/list/grade `6200d16` smoke E2E pass; 4.D FE Siswa 1/2 ✅ DONE 4.D.1 list+panel+detail page `9f8e9d0`+`fe50c66`, 4.D.2 dashboard riwayat ⏳ deferable; locked #70-#74; NEXT: Task 4.E FE Guru Review)
- [ ] Fase 5 — Soal Bab
