...
- Roadmap & locked decisions: `.kiro/steering/lms-roadmap.md` (v0.12.0 — Fase 7 OPEN, decomposed 12 task A-G, head `75316bd`).
  - Fase 4 14/14, Fase 5 15/15 + UX/QA pass `22d2095`, Fase 6 15/15 + UX/QA pass `6e10888`, **Fase 7 IN PROGRESS** (7.A.1 ✅ + 7.A.2 ✅ + 7.B ✅ + 7.C ✅ + **7.D ✅ pending counters consolidated** commit `75316bd`, smoke 7.A 16/16 + 7.B 17/17 + 7.C 16/16 + 7.D 11/11 hijau).
...
- Active focus: **Fase 7 Task 7.E — guru audit scope per kelas** (locked #59: `GET /api/v1/guru/kelas/:id/audit?action=<filter>&limit=50` filter allowlist hasil_reset/ujian_attempt_reset/bab_archived/bab_published/siswa_kicked/tugas_deleted/submission_graded/ujian_auto_graded, hanya entry `target_kelas_id=:id` AND kelas.guru_id=actor).
...
- [-] Fase 7 — Rekap Nilai + Activity Feed (IN PROGRESS, decomposed 12 task A-G, head `75316bd`)
  ...
  - **Next**: Task 7.E — guru audit scope per kelas (locked #59).
- [ ] Fase 7 (sisa) — 7.E Guru audit log / 7.F UX/QA pass / 7.G close v0.13.0
- [ ] Fase 8 — Polish + E2E
