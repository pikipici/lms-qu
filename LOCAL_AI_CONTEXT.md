...
- Roadmap & locked decisions: `.kiro/steering/lms-roadmap.md` (v0.12.0 — Fase 7 OPEN, decomposed 12 task A-G, head `6bf3f0e`).
  - Fase 4 14/14, Fase 5 15/15 + UX/QA pass `22d2095`, Fase 6 15/15 + UX/QA pass `6e10888`, **Fase 7 IN PROGRESS** (7.A.1 ✅ + 7.A.2 ✅ + 7.B ✅ + 7.C ✅ + 7.D ✅ + 7.E ✅ + **7.F ✅ UX/QA pass** commit `6bf3f0e`, smoke 7.A 16/16 + 7.B 17/17 + 7.C 16/16 + 7.D 11/11 + 7.E 20/20 + 7.F regression 16/16 = 96/96 hijau).
...
- Active focus: **Fase 7 Task 7.G — close v0.13.0** (bump roadmap Fase 7 CLOSED 12/12, tag v0.13.0, release notes summary).
...
- [-] Fase 7 — Rekap Nilai + Activity Feed (IN PROGRESS, decomposed 12 task A-G, head `6bf3f0e`)
  ...
  - **Next**: Task 7.G — close v0.13.0 (bump roadmap Fase 7 CLOSED 12/12, tag v0.13.0, release notes 6 features: siswa nilai/guru rekap+CSV/activity feed/pending counters/audit log/UX-QA pass).
- [ ] Fase 7 (sisa) — 7.G close v0.13.0
- [ ] Fase 8 — Polish + E2E
